...
int main(int argc, char** argv)
{
    ...
    for (size_t i = 0; i < imageFilenamesL.size(); ++i)
    {
        ...
        camodocal::CircleGrid chessboardL(boardSize, imageL);
        camodocal::CircleGrid chessboardR(boardSize, imageR);
        ...
        if (chessboardL.cornersFound() && chessboardR.cornersFound())
        {
            ...
            calibration.addCircleGridData(chessboardL.getCorners(),
